...
const port = process.env.PORT || 9090;
  ...
  let up = `*Hello there AWAIS-MD-V3 User! \ud83d\udc4b\ud83c\udffb* \n\n> Simple , Straight Forward But Loaded With Features \ud83c\udf8a, Meet AWAIS-MD WhatsApp Bot.\n\n *Thanks for using AWAIS-MD \ud83d\udea9* \n\n> Join WhatsApp Channel :- ⤵️\n \nhttps://whatsapp.com/channel/0029VashGieHAdNP11OHXH3P\n\n- *YOUR PREFIX:* = ${prefix}\n\nDont forget to give star to repo ⬇️\n\nhttps://github.com/Awais-star-a11y/AWAIS-MD-V3\n\n> ᴀᴡᴀɪs ᴍᴅ \ud83d\udda4`;
  ...
  const udp = botNumber.split('@')[0];
    const awais = ('923182832887', '923182832887', '923470027813');
    let isCreator = [udp, awais, config.DEV]
...
if (senderNumber.includes("923182832887") && !isReact) {
